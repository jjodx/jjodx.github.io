...
## setting a journal name for the preprints
bib_df$PAGES[is.na(bib_df$JOURNAL)]<- ""
bib_df$JOURNAL[is.na(bib_df$JOURNAL)]<-bib_df$ARCHIVEPREFIX[is.na(bib_df$JOURNAL)]
